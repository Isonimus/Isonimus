...
| Project | What it is | Stack |
|---|---|---|
| **[Stele](https://github.com/Isonimus/stele)** · [`npm`](https://www.npmjs.com/package/@isonimus/stele) | A zero-dependency workflow that keeps a repo's decisions, work, and definition of done honest — enforced by a git hook and CI, not by anyone remembering to. Vendored into any repo with one command. | TypeScript |
